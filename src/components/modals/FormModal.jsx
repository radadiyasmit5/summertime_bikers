  ...
  const cards = [
    {
      ...
      title: "I have a regular drivers license.",
      description: "Click here if you already have a regular driver's license.",
      path: '/withLicence'
    },
    {
      icon: <MdDirectionsBike size={40} />,
      title: "I do not have a regular drivers license.",
      description: "Click here if you don't have a regular driver's license yet.",
      path: '/withoutLicence'
    }
  ];
